...
class AccessEndpoints {
  ...
  static String fileAssignType(int fileId) => '${BaseUrl.baseUrl}/admin/files/$fileId/access-type';
  static String quizSetAssignType(int quizSetId) => '${BaseUrl.baseUrl}/admin/quiz-sets/$quizSetId/access-type';
