...
class _UserQuizSetsPageState extends State<UserQuizSetsPage>
    ...
    Future<void> fetchQuestionsAndSubmit(BuildContext context,
        ...
        try {
            ...
            if (kDebugMode) print('Error in fetchQuestionsAndSubmit: $e');
            ScaffoldMessenger.of(context).showSnackBar(
    ...
    void _navigateToQuestion(int displayNumber, BuildContext context) async {
        ...
        _pushToQuestion(displayNumber, context);
    }

    void _pushToQuestion(int displayNumber, BuildContext context) async {
        final quizData = await _quizDataFuture;
        Navigator.push(
            context,
            MaterialPageRoute(
